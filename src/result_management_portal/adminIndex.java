...
public class adminIndex extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B.Tech", "M.Tech", "MBA", "MSC", " " }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mechanical", "Civil", "Aeronautical", "Computer Science" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       ...
       try
       {
           ...
           String query="insert into student(rollno,course,Studentname,branchName,gender,fathername) values('"+ roll+"','"+ course+"','"+ name+"','"+ branch+"','"+ gender+"','"+ fatherName+"') ";
